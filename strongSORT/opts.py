...
class opts:
    def __init__(self):
        ...
        self.parser.add_argument(
            '--path_AFLink',
            type=str,
            default='/Users/laraschwarz/Code/reu2025/StrongSORT/AFLink_epoch20.pth'
        )
        self.parser.add_argument(
            '--dir_save',
            type=str,
    ...
    def parse(self, args=''):
        ...
        if opt.ECC:
            ...
            path_ECC = '/Users/laraschwarz/Code/reu2025/StrongSORT/{}_ECC_{}.json'.format(opt.dataset, opt.mode)
