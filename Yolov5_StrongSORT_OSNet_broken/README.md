...
## Instrucciones para el video tutorial

Creamos el entorno

     $ conda create -n YoloV5deeps'
     $ conda activate YoloV5deeps
     $ conda install python=3.8

Clonamos el repositorio e instalamos los paquetes
 
     $ git clone --recursive git@github.com:DavidReveloLuna/Yolov5_StrongSORT_OSNet.git
     $ cd Yolov5_StrongSORT_OSNet
     $ pip install -r requirements.txt
   
Probamos tracking

     $ python track.py --source 0 --strong-sort-weights osnet_x0_25_market1501.pt --yolo-weights yolov5n.pt
   
Verificar si se está disponible cuda para las librearias
...
Instalar soporte de cuda para pytorch

     $ conda install pytorch torchvision torchaudio cudatoolkit=11.3 -c pytorch
   
Probamos tracking en video

     $ python track.py --source video.mp4 --strong-sort-weights osnet_x0_25_market1501.pt --yolo-weights yolov5n.pt --save-vid

Filtrar por clases

     $ python track.py --source video.mp4 --strong-sort-weights osnet_x0_25_market1501.pt --yolo-weights yolov5n.pt --save-vid --classes 0
