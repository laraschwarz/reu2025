...
def run(
    ...
    ew_path = [(189.5, 201.0), (189.5, 201.5), (192.0, 203.0), (195.0, 204.0), (199.5, 205.0), (198.0, 205.5), (199.0, 206.5), (203.5, 207.5), (209.0, 210.0), (208.5, 211.5), (210.5, 213.0), (214.0, 213.5), (216.0, 214.5), (220.0, 217.5), (248.5, 202.0), (253.5, 201.5), (231.5, 221.0), (234.5, 222.5), (244.5, 227.5), (248.0, 229.5), (256.5, 232.5), (263.0, 235.0), (268.5, 237.0), (272.5, 239.0), (281.0, 242.0), (287.5, 243.5), (298.5, 249.0), (307.5, 253.0), (319.0, 259.0), (330.0, 262.0), (337.5, 263.0), (349.5, 268.5), (364.0, 273.0), (378.0, 278.5), (395.0, 285.5), (411.5, 289.5), (421.5, 293.0), (605.5, 244.0), (597.5, 241.0), (596.0, 241.0), (585.0, 238.0), (595.0, 236.0), (531.0, 227.0), (525.0, 226.0), (514.0, 222.5), (513.0, 220.0), (483.0, 217.5), (478.5, 215.0), (448.0, 209.0), (437.5, 207.5), (433.5, 206.0), (419.0, 204.5), (407.0, 203.0), (398.5, 201.0), (383.0, 200.0), (373.5, 198.0)] 
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            for tid, points in coords.items():
                ...
                if not any(tid in frame_ids for frame_ids in recent_ids):  # if the track has disappeared in the last 5 frames (aka permanently)
                    ...
                    # if tid==67 or tid==31: print(f"ID {tid} ({id_to_class.get(tid, 'unknown')}) points: {points} \n")
